...
The powershell-module-for-vmware-cloud-foundation-certificate-management project team welcomes contributions from the community.
...
``` shell
git remote add upstream https://github.com/vmware/powershell-module-for-vmware-cloud-foundation-certificate-management.git
