...
@{
    ...
    FunctionsToExport = 'Get-EsxiCertificateThumbprint', 'Get-vCenterCertificateThumbprint', 'Confirm-ESXiCertificateInstalled', 'Confirm-CAInvCenterServer', 'Request-EsxiCsr', 'Get-vCenterCertManagementMode', 'Set-vCenterCertManagementMode', 'Get-vSANHealthSummary', 'Get-ESXiLockdownMode', 'Set-ESXiLockdownMode', 'Restart-EsxiHost', 'Install-EsxiCertificate'
